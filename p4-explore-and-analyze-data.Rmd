...
ggplot(uber,
  ...
  ylab('Number of Pickups') +
  xlab('Month') +
  ggsave('pickups_per_month_barplot.png')
...
```{r echo=FALSE, Borough_Pickups}
# Boxplot of pickups by Borough
ggplot(uber_known.by_loc,
  ...
  ylab('Number of Pickups') +
  ggsave('pickups_by_location_boxplot.png')
...
```{r echo=FALSE, Rides_Over_Time}
# Number of Rides over time Colored by Day
ggplot(uber,
       aes(x = date)) +
  geom_histogram(binwidth = 1,
                aes(fill = day)) +
