...
hour at 11pm.  I was able to find [another bulletin](http://www.nyc.gov/html/nypd/html/pr/pr_2015_traffic_2015_06_26.shtml)
from the NYC Police Department that seemed to explain the huge surge in pickups.
Another mixture of local festivals and a marathon was responsible for the
increase.  And again, demand on Sunday, Monday and Tuesday afterwards was 
...
biggest Saturdays in May and June (the 16th and 27th, respectively).  I was also
interested in how things changed on the lowest Saturday (May 23rd).  All 3 days
...
dramatically after 10am on Saturdays in general. 
...
Ridership varied dramatically from week to week over the 6 months but a few 
patterns remained constant.  Demand was consistently greatest on Friday and
...
marathons.  Uber as an organization could benefit from trying to forma city
partnerships to promote more activities as they seem to lead to surges in
demand.  

Uber drivers could benefit from having more data to help maximize their 
time on the road.  As a former driver, I understand the struggle to figure out 
when to start working and when to stop for each day.  Because they are 
...
however; because it's difficult to predict without experience.  It was fun 
testing my theories about peak times even when I was proven wrong.  I had no 
idea that a Thursday or even a Wednesday could be nearly as profitable as a 
Friday in some cases.  I was also surprised to learn that demand spiked so much 
around 6pm and that there really wasn't much of a lunch rush Monday-Friday.


### Did you observe any interesting relationships between the other features \
(not the main feature(s) of interest)?

The May faceted histogram helped me understand demand changes over time.
Although it was not a particularly eventful day, May 25th caught my attention in
the faceted histogram because it didn't look like any other Monday in the graph.
The usual 8am peak was curiously absent and although it was the least busy day 
in May and June, it started higher than all of the other Mondays.  It turns out
it was because it was Memorial day.  Again, not a particularly interesting day 
but still helpful for extrapolating to other Monday holidays.
...
Most rides originated from Manhattan, with a few outliers in Brooklyn, Queens
and JFK Airport (lower right orange circle).  I pulled the latitude and
longitude data using the Google Maps API and merged this data with the uber
pickup data to generate the map.
...
This heatmap shows at a glance the busiest (June 27th) and slowest (Jan 27th)
days during the 6-month time period.  It also highlights the overall trend of
increasing ridership over time.  While January was mostly low in demand, things
heated up slowly over time.  It was also interesting to note that while February
was the shortest month, more people used the service each day on average than 
in March or April.
...
6-month time period.  The top graph is colored by day, which highlighted how 
demand rose along a gradient from Sunday (yellow) through Saturday (dark red).
I threw in a smoothing curve to show the average demand for all days (blue).
The bottom graph helps distinguish the two types of demand curves for Monday -
Friday vs Saturday and Sunday.  It was interesting to see that both Saturday
and Sunday start higher at midnight and don't include an 8am bump in demand.
...
These 4 graphs would probably be of most use to an Uber driver trying to
increase their profits.  The map scatterplot clearly highlights the best places
to go while the colored pickups by hour scatterplot tells him when to be there.
I think that Uber should share more of this type of data with drivers.  It takes
a lot of the guesswork out of driving and would eliminate a lot of regret about
whether they are missing out on opportunities.

Sharing data is becoming more and more common and has done wonders for other
companies.  When LinkdIn started sharing even simple data (who's looked at your
profile and profile tips), their popularity skyrocketed.  People want data to
make more informed choices.  This could be a win-win for both sides.  Drivers
would be more satisfied, leading to lower turnover and passengers would be
better served by more experienced drivers.
